...
```js
let uint8Array = new Uint8Array([0, 72, 101, 108, 108, 111, 0]); // \x00Hello\x00
...
encoder.encodeInto('1234', uint8Array)
alert(uint8Array); // 72,101,108,108,111

console.log(new TextDecoder().decode(uint8Array)) // 1234o
```